...
private:
    ...
    void selectWaypoints() {
        ...
        relative_goals = {
            {0.35, 0.0, 0.0},   //move foward   0
            {0.2, -0.2, -0.785},//move foward   45
            {0.0, -1.1, -0.785},//move foward   90
            {0.5, 0.0, 1.57},   //move foward   0   
            {0.0, 0.45, 1.57},  //move foward   -90
            {0.4, 0.0, 0.0},    //move right    -90
            {0.0, 0.5, 0.0},    //move foward   -90
            {0.6, 0.0, 0.0},    //move right    -90
            {0.0, 0.9, 0.0},    //move foward   -90
            {-0.5, 0.0, 1.57},  //move foward   -180
            {0.0, -0.3, 0.0},   //move left     -180
            {-0.4, 0.0, 0.0},   //move foward   -180
            {-0.3, 0.3, -0.785},//move foward   -135
            {-0.6, 0.0, 0.785}, //move foward   -180
            {0.0, 0.0, 3.145}                    0
        };
    }
    ...
    void controlLoop() {
        ...
        // vel.linear.x = cos_phi * control_x + sin_phi * control_y;
        // vel.linear.y = -sin_phi * control_x + cos_phi * control_y;
